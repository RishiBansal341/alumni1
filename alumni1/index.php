    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                ...
                <a class="navbar-brand js-scroll-trigger"  href="./"> Rajasthan Technical University Alumni Management system</a>
...
<div class="modal fade" id="confirm_modal" role='dialog'>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                        ...
                        <div class="text-white">+91-8209703067</div>
                    </div>
                    <div class="col-lg-4 mr-auto text-center">
                        <i class="fas fa-envelope fa-3x mb-3 text-muted"></i>
                        <!-- Make sure to change the email address in BOTH the anchor text and the link target below!-->
                        <a class="d-block" href="mailto:registrar@rtu.ac.in">registrar@rtu.ac.in</a>
                    </div>
                </div>
            </div>
            <br>
  ...
  <div class="small text-center text-muted">
    <?php echo $_SESSION['system']['name'] ?> | Rajasthan Technical University
  </div>
</div>
